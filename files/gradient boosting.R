...
control_full_data_train_85004=trainControl(method="cv",number=10)
fit=train(sold_count~.,method="gbm",trControl=control_full_data_train_85004,data=full_data_train_85004)
fit$bestTune
gbm=gbm(sold_count~.-product_content_id-date,distribution = "poisson",data=full_data_train_85004,n.trees = 150,interaction.depth = 3,shrinkage = 0.1,n.minobsinnode = 10)
summary(gbm)
predicted_85004=predict(gbm,full_data_test_85004,n.trees = 150,type="response")
...
control_full_data_train_31515569=trainControl(method="cv",number=10)
fit=train(sold_count~.,method="gbm",trControl=control_full_data_train_31515569,data=full_data_train_31515569)
fit$bestTune
gbm=gbm(sold_count~.-product_content_id-date,distribution = "poisson",data=full_data_train_31515569,n.trees = 100,interaction.depth = 3,shrinkage = 0.1,n.minobsinnode = 10)
summary(gbm)
predicted_31515569=predict(gbm,full_data_test_31515569,n.trees = 150,type="response")
...
control_full_data_train_7061886=trainControl(method="cv",number=10)
fit=train(sold_count~.,method="gbm",trControl=control_full_data_train_7061886,data=full_data_train_7061886)
fit$bestTune
gbm=gbm(sold_count~.-product_content_id-date,distribution = "poisson",data=full_data_train_7061886,n.trees = 50,interaction.depth = 3,shrinkage = 0.1,n.minobsinnode = 10)
summary(gbm)
predicted_7061886=predict(gbm,full_data_test_7061886,n.trees = 150,type="response")
...
control_full_data_train_6676673=trainControl(method="cv",number=10)
fit=train(sold_count~.,method="gbm",trControl=control_full_data_train_6676673,data=full_data_train_6676673)
fit$bestTune
gbm=gbm(sold_count~.-product_content_id-date,distribution = "poisson",data=full_data_train_6676673,n.trees = 50,interaction.depth = 3,shrinkage = 0.1,n.minobsinnode = 10)
summary(gbm)
predicted_6676673=predict(gbm,full_data_test_6676673,n.trees = 150,type="response")
...
control_full_data_train_5926527=trainControl(method="cv",number=10)
fit=train(sold_count~.,method="gbm",trControl=control_full_data_train_5926527,data=full_data_train_5926527)
fit$bestTune
gbm=gbm(sold_count~.-product_content_id-date,distribution = "poisson",data=full_data_train_5926527,n.trees = 150,interaction.depth = 3,shrinkage = 0.1,n.minobsinnode = 10)
summary(gbm)
predicted_5926527=predict(gbm,full_data_test_5926527,n.trees = 150,type="response")
...
control_full_data_train_3904356=trainControl(method="cv",number=10)
fit=train(sold_count~.,method="gbm",trControl=control_full_data_train_3904356,data=full_data_train_3904356)
fit$bestTune
gbm=gbm(sold_count~.-product_content_id-date,distribution = "poisson",data=full_data_train_3904356,n.trees = 50,interaction.depth = 3,shrinkage = 0.1,n.minobsinnode = 10)
summary(gbm)
predicted_3904356=predict(gbm,full_data_test_3904356,n.trees = 150,type="response")
...
control_full_data_train_4066298=trainControl(method="cv",number=10)
fit=train(sold_count~.,method="gbm",trControl=control_full_data_train_4066298,data=full_data_train_4066298)
fit$bestTune
gbm=gbm(sold_count~.-product_content_id-date,distribution = "poisson",data=full_data_train_4066298,n.trees = 100,interaction.depth = 3,shrinkage = 0.1,n.minobsinnode = 10)
summary(gbm)
predicted_4066298=predict(gbm,full_data_test_4066298,n.trees = 150,type="response")
...
control_full_data_train_32939029=trainControl(method="cv",number=10)
fit=train(sold_count~.,method="gbm",trControl=control_full_data_train_32939029,data=full_data_train_32939029)
fit$bestTune
gbm=gbm(sold_count~.-product_content_id-date,distribution = "poisson",data=full_data_train_32939029,n.trees = 150,interaction.depth = 3,shrinkage = 0.1,n.minobsinnode = 10)
summary(gbm)
predicted_32939029=predict(gbm,full_data_test_32939029,n.trees = 150,type="response")
...
sonuc_4=select(part_d_matrix,predicted_85004_overallMAPE,predicted_31515569_overallMAPE,predicted_7061886_overallMAPE,predicted_6676673_overallMAPE,predicted_5926527_overallMAPE,predicted_3904356_overallMAPE,predicted_4066298_overallMAPE,predicted_32939029_overallMAPE)
mape_plot_3 = data.table(id= 85004, 31515569, 7061886, 6676673, 5926527, 3904356, 4066298, 32939029)
mape_plot_3 =transpose(mape_plot_3)
mape_plot_3$V1=as.character(mape_plot_3$V1)
Gradient_Boosting_MAPE=data.table(c("Gradient_Boosting_MAPE"))
mape_plot_3$V2=Gradient_Boosting_MAPE[1,]
mape_plot_3$V3=transpose(sonuc_4[1,])
mape_plot_sonn=rbind(mape_plot_son,mape_plot_3)

ggplot(mape_plot_3, aes(V1, V3, colour=V2)) +
  ...
  labs(title= "MAPE Values for Gradient Boosting",
       x= "Product ID",
       y= "MAPE") +
