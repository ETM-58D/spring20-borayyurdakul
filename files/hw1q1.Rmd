...
1. [Codes for answer of Question 1.a](https://github.com/ETM-58D/spring20-borayyurdakul/blob/master/files/q1a.html)
...
2. [Codes for answer of Question 1.b](https://github.com/ETM-58D/spring20-borayyurdakul/blob/master/files/q1b.html)

    Use the value of this fraction at D = 2 and D = 3 to get estimates for the value of 𝜋 as you know the area (for D = 2) and volume (for D = 3) formulae for these cases. (5 points)
    
3. [Codes for answer of Question 1.c](https://github.com/ETM-58D/spring20-borayyurdakul/blob/master/files/q1c.html)

    This exercise is an alternative example to illustrate curse of dimensionality. You are asked to sample 1000 D-dimensional points from 1 to 10 dimensions, where the value in each dimension is uniformly randomly distributed between -1 and +1. For each value of D, generate an additional 100 new instances. For each of the new instances, find the closest point in 1000 instances using Euclidean distance. You are expected to end up with 100 calculated distances after this operation. Plot the average distance as a function of D (i.e. a scatter/line plot of D versus average distance). (10 points)